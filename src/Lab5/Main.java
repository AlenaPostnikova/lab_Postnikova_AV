...
//        String text = ("Поскольку я с удовольствием перепоручу ваших пациентов доктору Эвансу, если вы слишком заняты.");
//        String longWord = LongWord.searchLongWord(text);
...
//
//        System.out.println(Substring.substringSearch("Мама мыла раму, рама вымыта мамой", "ма"));

//        System.out.println(Opposite.methodOpposite(new StringBuilder("This is a test string")));
